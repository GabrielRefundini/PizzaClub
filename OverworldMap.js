class OverworldMap {
  ...
  checkForActionCutscene() {
    ...
    if (!this.isCutscenePlaying && match && match.talking.length) {
      ...
      relevantScenario &&
        this.startCutscene(
          typeof relevantScenario.events === "function"
            ? relevantScenario.events()
            : relevantScenario.events
        );
    }
  }
        ...
        talking: [
          {
            ...
            required: () =>
              playerState.storyFlags["USED_PIZZA_STONE"] === false,
            events: [
              {
        ...
        talking: [
          {
            events() {
              ...
              if (npc.currentRequestedPizza) {
                ...
                const pizzaType =
                  keys[utils.getRandomIntBetween(0, keys.length - 1)];
